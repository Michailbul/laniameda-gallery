...
export function UploadModal({ open, onClose, availableTags, folders }: UploadModalProps) {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="relative z-10 flex h-[82vh] w-full max-w-6xl flex-col overflow-hidden rounded-[28px] border border-border/60 bg-background/90 shadow-2xl shadow-black/70 backdrop-blur"
