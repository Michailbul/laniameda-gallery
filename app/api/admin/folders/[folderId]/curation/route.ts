...
const bulkSetFolderCurationMutation = makeFunctionReference<"mutation">(
  "assets:bulkSetFolderCuration",
);
...
export async function POST(
  ...
  try {
    ...
    const result = await client.mutation(bulkSetFolderCurationMutation, {
