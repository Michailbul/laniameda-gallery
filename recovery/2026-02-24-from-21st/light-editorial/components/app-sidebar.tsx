            ...
            <div className="px-2">
              <div
                ...
                onFocus={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = "0 0 0 2px rgba(255,122,100,0.12)";
                }}
                onBlur={(e) => {
                  e.currentTarget.style.borderColor = "var(--border-default)";
        ...
        >
          <div className="relative flex-shrink-0">
            <div
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = "0 0 0 2px var(--coral)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.boxShadow = "none";
              }}
...
function NavItem({
  ...
  const baseStyle: React.CSSProperties = {
    ...
    backgroundColor: active ? "rgba(255,122,100,0.05)" : "transparent",
    ...
    <button
      ...
      onMouseEnter={(e) => {
        if (!active) {
          ...
          e.currentTarget.style.backgroundColor = "rgba(255,122,100,0.08)";
        }
      }}
      onMouseLeave={(e) => {
        if (!active) {
          ...
          e.currentTarget.style.backgroundColor = "rgba(255,122,100,0.05)";
        }
      }}
      ...
      {collapsed ? (
        <span
          ...
          style={{
            ...
            color: active ? "var(--coral)" : "var(--text-ghost)",
          }}
        >
          {label[0]?.toUpperCase()}
        </span>
        ...
        <>
          ...
          {count !== undefined && (
            <span
              ...
              style={{
                backgroundColor: active ? "rgba(255, 122, 100, 0.12)" : "var(--surface-3)",
                color: active ? "var(--coral)" : "var(--text-ghost)",
              }}
            >
              {count}
