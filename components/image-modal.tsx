...
export function ImageModal({ open, onClose, image, onAction }: ImageModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[60] animate-fade-in">
      {/* Backdrop — multi-layer warm radial */}
      <div
        className="absolute inset-0"
        style={{
          background: `
            radial-gradient(ellipse 60% 50% at 30% 70%, rgba(255, 107, 53, 0.06) 0%, transparent 50%),
            radial-gradient(ellipse 50% 40% at 70% 30%, rgba(255, 140, 66, 0.04) 0%, transparent 45%),
            radial-gradient(ellipse at center, rgba(74, 30, 10, 0.12) 0%, rgba(8, 4, 2, 0.97) 65%)
          `,
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {ACTIONS.map(({ intent, label, icon: Icon }) => (
                <button
                  ...
                  style={{
                    background: "linear-gradient(135deg, var(--surface-2), rgba(28,18,11,0.8))",
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow =
                      "0 4px 20px rgba(255, 140, 66, 0.12), 0 0 0 1px rgba(255, 140, 66, 0.08)";
                ...
                >
                  <Icon
                    className="h-4 w-4 transition-colors group-hover/action:text-amber-400"
