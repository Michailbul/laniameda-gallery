...
export function AppSidebar({
  ...
  return (
    <aside
      className="fixed left-0 top-0 z-40 flex h-dvh flex-col overflow-hidden border-r grain-overlay"
      style={{
        width: sidebarWidth,
        background: "linear-gradient(180deg, rgba(17,10,6,0.98) 0%, var(--surface-0) 50%, rgba(8,4,2,0.99) 100%)",
            ...
            <div className="px-2">
              <div
                ...
                onFocus={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = "0 0 0 1px var(--amber-9), 0 0 8px rgba(255,140,66,0.12)";
                }}
                onBlur={(e) => {
                  e.currentTarget.style.borderColor = "var(--border-default)";
        ...
        >
          <div className="relative flex-shrink-0">
            <div
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = "0 0 0 2px var(--amber-9)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.boxShadow = "none";
              }}
            ...
            {user && (
              <span
                ...
                style={{
                  ...
                  boxShadow: "0 0 6px rgba(255, 140, 66, 0.45)",
                }}
              />
            )}
          </div>
...
function NavItem({
  ...
  const baseStyle: React.CSSProperties = {
    ...
    borderLeft: active ? "3px solid var(--amber-9)" : "3px solid transparent",
    boxShadow: active ? "-4px 0 12px rgba(255, 140, 66, 0.18)" : "none",
    cursor: "pointer",
  };
  ...
  return (
    <button
      ...
      style={{
        ...
        backgroundColor: active ? "var(--accent-subtle)" : "transparent",
        borderLeft: active ? "2px solid var(--amber-9)" : "2px solid transparent",
        transitionDuration: "var(--duration-fast)",
        minWidth: 0,
      }}
      onMouseEnter={(e) => {
      ...
      {collapsed ? (
        <span
          ...
          style={{
            ...
            color: active ? "var(--amber-9)" : "var(--text-ghost)",
          }}
        >
          {label[0]?.toUpperCase()}
        </span>
        ...
        <>
          ...
          {count !== undefined && (
            <span
              ...
              style={{
                backgroundColor: active ? "rgba(255, 140, 66, 0.14)" : "var(--surface-3)",
                color: active ? "var(--amber-11)" : "var(--text-ghost)",
              }}
            >
              {count}
            </span>
